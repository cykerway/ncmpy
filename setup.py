...
setup(
    ...
    long_description = '''
        ...
        ncmpy is an MPD client based on Curses. Besides basic playback control and playlist/database management, it supports song rating, auto lyrics fetching and saving, lyrics highlighting and OSD, and searching by tags.
    ''', 
    classifiers = [
